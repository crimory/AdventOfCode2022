...
public class OriginalSolutionTests
{
    [Theory]
    ...
    {
        var result = Solution.FindFirstDistinctMarkerOriginal(input);
    ...
    {
        var result = Solution.FindFirstDistinctMarkerOriginal(input, 14);
        Assert.Equal(expectedReturnedMarkerIndex, result);
    }
}